...
const _sfc_main = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h4${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ id: __props.id }, _attrs))}><a${serverRenderer.exports.ssrRenderAttr("href", `#${__props.id}`)}>`);
...
//# sourceMappingURL=ProseH4.dc6a1e7e.mjs.map
