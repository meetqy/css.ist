import { g as useContent, l as getContentByTag, v as vLazy, m as __nuxt_component_3 } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const moreContent = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getContentByTag(page.value.tags, {
      pageIndex: 1,
      pageSize: 12
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (vue_cjs_prod.unref(page)) {
              ...
              _push2(`<p class="mt-8"${_scopeId}><span${_scopeId}>tags:</span><!--[-->`);
              serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(page).tags, (item) => {
                _push2(`<span class="btn btn-primary btn-xs ml-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(item)}</span>`);
              });
              _push2(`<!--]--></p><h2 class="capitalize"${_scopeId}>more</h2><div class="grid grid-cols-4 gap-x-4"${_scopeId}><!--[-->`);
              serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(moreContent), (item) => {
                _push2(`<div${_scopeId}><img${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "w-full aspect-square object-cover object-top rounded-box" }, serverRenderer.exports.ssrGetDirectiveProps(_ctx, _directive_lazy, vue_cjs_prod.unref(vLazy)(item.previews[0]))))}${_scopeId}><p class="px-2"${_scopeId}>${serverRenderer.exports.ssrInterpolate(item.title)}</p></div>`);
              });
              ...
              vue_cjs_prod.unref(page) ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                ...
                vue_cjs_prod.createVNode("div", { class: "container m-auto bg-info/5 pb-8 rounded-b" }, [
                  vue_cjs_prod.createVNode("article", { class: "prose max-w-full px-4 pt-8" }, [
                    ...
                    vue_cjs_prod.createVNode("p", { class: "mt-8" }, [
                      ...
                      (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(vue_cjs_prod.unref(page).tags, (item) => {
                        return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("span", { class: "btn btn-primary btn-xs ml-2" }, vue_cjs_prod.toDisplayString(item), 1);
                      }), 256))
                    ]),
                    vue_cjs_prod.createVNode("h2", { class: "capitalize" }, "more"),
                    vue_cjs_prod.createVNode("div", { class: "grid grid-cols-4 gap-x-4" }, [
                      (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(vue_cjs_prod.unref(moreContent), (item) => {
                        return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                          key: item._id
                        }, [
                          vue_cjs_prod.withDirectives(vue_cjs_prod.createVNode("img", { class: "w-full aspect-square object-cover object-top rounded-box" }, null, 512), [
                            [_directive_lazy, vue_cjs_prod.unref(vLazy)(item.previews[0])]
                          ]),
                          vue_cjs_prod.createVNode("p", { class: "px-2" }, vue_cjs_prod.toDisplayString(item.title), 1)
                        ]);
                      }), 128))
                    ])
                  ])
...
//# sourceMappingURL=_...slug_.a85c786c.mjs.map
