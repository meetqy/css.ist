...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<main${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "prose m-auto py-12" }, _attrs))}><h1>wcao.cc</h1><p>\u5B8C\u5584\u4E2D...</p></main>`);
}
...
//# sourceMappingURL=index.46b63c80.mjs.map
