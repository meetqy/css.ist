...
import { u as useAsyncData } from './ContentQuery.cd208b61.mjs';
import 'h3';
import 'ufo';
...
vue_cjs_prod.defineAsyncComponent(() => import('./footer.a36ea9c2.mjs').then((c) => c.default || c));
...
vue_cjs_prod.defineAsyncComponent(() => import('./ContentDoc.9a2c3096.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentList.99311199.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return ContentNavigation;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentQuery.cd208b61.mjs').then(function(n) {
  return n.C;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentRenderer.d4e1a678.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentRendererMarkdown.b8673984.mjs').then((c) => c.default || c));
...
vue_cjs_prod.defineAsyncComponent(() => import('./Markdown.14084fee.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseA.1e13add6.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseBlockquote.087cab5c.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseCode.060ac4ec.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseCodeInline.daf48b42.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseEm.4bc341c9.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH1.8a3cd664.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH2.4b3cee36.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH3.e353ea12.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH4.0fb4e48c.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH5.6ceab25b.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH6.7a2e4251.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseHr.3b73fd6a.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseImg.d7260f54.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseLi.8a9b3c9a.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseOl.1acc17dd.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseP.c3c8d459.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseStrong.09c1bec1.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTable.8c3e2574.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTbody.2a8cb4dc.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTd.88d72fa6.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTh.ab3eed66.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseThead.13c273a0.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTr.04df8440.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseUl.c1eac40d.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return welcome$1;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./server.mjs').then(function(n) {
...
//# sourceMappingURL=ContentNavigation.cdf99fdd.mjs.map
