...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.0e0e18ef.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.505050af.mjs'));
...
//# sourceMappingURL=error-component.00a5dc88.mjs.map
