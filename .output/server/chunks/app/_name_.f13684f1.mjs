import { u as useRoute, o as drawerContentScroll, p as drawerContentPullUpEnd, v as vLazy, l as getContentByTag, m as __nuxt_component_3, j as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    if (!storage.value || !storage.value.length) {
      list.value = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getData()), __temp = await __temp, __restore(), __temp);
    }
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (list.value) {
              ...
              _push2(`<!--]--></div><div class="flex justify-between items-center mt-24"${_scopeId}><div class="flex-1 border-t border-dotted border-base-content/20"${_scopeId}></div><span class="px-12 text-base-content/50 font-medium font-sans"${_scopeId}> end </span><div class="flex-1 border-t border-dotted border-base-content/20"${_scopeId}></div></div></main>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              list.value ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("main", {
                ...
                vue_cjs_prod.createVNode("div", { class: "flex justify-between items-center mt-24" }, [
                  vue_cjs_prod.createVNode("div", { class: "flex-1 border-t border-dotted border-base-content/20" }),
                  vue_cjs_prod.createVNode("span", { class: "px-12 text-base-content/50 font-medium font-sans" }, " end "),
                  vue_cjs_prod.createVNode("div", { class: "flex-1 border-t border-dotted border-base-content/20" })
                ])
...
//# sourceMappingURL=_name_.f13684f1.mjs.map
