...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.d296007c.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.450a636d.mjs'));
...
//# sourceMappingURL=error-component.f6c2f82d.mjs.map
