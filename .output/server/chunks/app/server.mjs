...
const components = {
  ContentDoc: vue_cjs_prod.defineAsyncComponent(() => import('./ContentDoc.a1edda17.mjs').then((c) => c.default || c)),
  ContentList: vue_cjs_prod.defineAsyncComponent(() => import('./ContentList.d247d905.mjs').then((c) => c.default || c)),
  ContentNavigation: vue_cjs_prod.defineAsyncComponent(() => import('./ContentNavigation.2a5598fa.mjs').then((c) => c.default || c)),
  ContentQuery: vue_cjs_prod.defineAsyncComponent(() => import('./ContentQuery.efac49c9.mjs').then(function(n) {
    return n.C;
  }).then((c) => c.default || c)),
  ContentRenderer: vue_cjs_prod.defineAsyncComponent(() => import('./ContentRenderer.6594c56c.mjs').then((c) => c.default || c)),
  ContentRendererMarkdown: vue_cjs_prod.defineAsyncComponent(() => import('./ContentRendererMarkdown.d802c5f0.mjs').then((c) => c.default || c)),
  ...
  Markdown: vue_cjs_prod.defineAsyncComponent(() => import('./Markdown.5959bb90.mjs').then((c) => c.default || c)),
  ProseA: vue_cjs_prod.defineAsyncComponent(() => import('./ProseA.f0f5379b.mjs').then((c) => c.default || c)),
  ProseBlockquote: vue_cjs_prod.defineAsyncComponent(() => import('./ProseBlockquote.6f10fef5.mjs').then((c) => c.default || c)),
  ProseCode: vue_cjs_prod.defineAsyncComponent(() => import('./ProseCode.e7de29c5.mjs').then((c) => c.default || c)),
  ProseCodeInline: vue_cjs_prod.defineAsyncComponent(() => import('./ProseCodeInline.91db33ab.mjs').then((c) => c.default || c)),
  ProseEm: vue_cjs_prod.defineAsyncComponent(() => import('./ProseEm.32babe0c.mjs').then((c) => c.default || c)),
  ProseH1: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH1.1278d680.mjs').then((c) => c.default || c)),
  ProseH2: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH2.aa166ab4.mjs').then((c) => c.default || c)),
  ProseH3: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH3.8060c9dc.mjs').then((c) => c.default || c)),
  ProseH4: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH4.6b478dd2.mjs').then((c) => c.default || c)),
  ProseH5: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH5.bd961eed.mjs').then((c) => c.default || c)),
  ProseH6: vue_cjs_prod.defineAsyncComponent(() => import('./ProseH6.0bb0b3cf.mjs').then((c) => c.default || c)),
  ProseHr: vue_cjs_prod.defineAsyncComponent(() => import('./ProseHr.e7483d46.mjs').then((c) => c.default || c)),
  ProseImg: vue_cjs_prod.defineAsyncComponent(() => import('./ProseImg.d7260f54.mjs').then((c) => c.default || c)),
  ProseLi: vue_cjs_prod.defineAsyncComponent(() => import('./ProseLi.93fa9831.mjs').then((c) => c.default || c)),
  ProseOl: vue_cjs_prod.defineAsyncComponent(() => import('./ProseOl.73fc1c05.mjs').then((c) => c.default || c)),
  ProseP: vue_cjs_prod.defineAsyncComponent(() => import('./ProseP.8fdc9282.mjs').then((c) => c.default || c)),
  ProseStrong: vue_cjs_prod.defineAsyncComponent(() => import('./ProseStrong.a37fbfb4.mjs').then((c) => c.default || c)),
  ProseTable: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTable.08397dfa.mjs').then((c) => c.default || c)),
  ProseTbody: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTbody.19efdb36.mjs').then((c) => c.default || c)),
  ProseTd: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTd.1263758a.mjs').then((c) => c.default || c)),
  ProseTh: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTh.520f0019.mjs').then((c) => c.default || c)),
  ProseThead: vue_cjs_prod.defineAsyncComponent(() => import('./ProseThead.2039e6db.mjs').then((c) => c.default || c)),
  ProseTr: vue_cjs_prod.defineAsyncComponent(() => import('./ProseTr.b69c0113.mjs').then((c) => c.default || c)),
  ProseUl: vue_cjs_prod.defineAsyncComponent(() => import('./ProseUl.b584159e.mjs').then((c) => c.default || c))
};
...
const layouts = {
  default: vue_cjs_prod.defineAsyncComponent(() => import('./default.565ae582.mjs')),
  template: vue_cjs_prod.defineAsyncComponent(() => import('./template.0ee86c45.mjs'))
};
...
const routes = [
  {
    ...
    meta: meta$5,
    alias: [],
    component: () => import('./_...slug_.9a1e7b84.mjs')
  },
  {
    name: "about",
    path: "/about",
    ...
    meta: meta$4,
    alias: [],
    component: () => import('./index.099a2fed.mjs')
  },
  {
    name: "index",
    path: "/",
    ...
    meta: meta$3,
    alias: [],
    component: () => import('./index.aa8ef685.mjs')
  },
  {
    name: "page-pageIndex",
    path: "/page/:pageIndex",
    ...
    meta: meta$2,
    alias: [],
    component: () => import('./_pageIndex_.a0283799.mjs')
  },
  {
    name: "tag-name",
    path: "/tag/:name",
    ...
    meta: meta$1,
    alias: [],
    component: () => import('./_name_.ab8d007a.mjs')
  },
  {
    name: "template-path",
    path: "/template/:path",
    ...
    meta,
    alias: [],
    component: () => import('./_path_.ef4b3a74.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./error-component.54c714b5.mjs'));
    const nuxtApp = useNuxtApp();
