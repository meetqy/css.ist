...
import { b as useNuxtApp, f as useState, g as useContent, i as fetchContentNavigation, h as hash, a as useHead, _ as _export_sfc, e as componentName, j as __nuxt_component_0$1 } from './server.mjs';
import { u as useAsyncData } from './ContentQuery.7dd23096.mjs';
import 'h3';
import 'ufo';
...
const welcome = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d2e18222"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_ClientOnly, vue_cjs_prod.mergeProps({
...
const component_vue3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const component_vue3$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": component_vue3
}, Symbol.toStringTag, { value: "Module" }));
vue_cjs_prod.defineAsyncComponent(() => import('./footer.4c6f4cfc.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./server.mjs').then(function(n) {
  return n.C;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./server.mjs').then(function(n) {
  return n.D;
...
vue_cjs_prod.defineAsyncComponent(() => import('./ContentDoc.f13ac486.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentList.9c42636d.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return ContentNavigation;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentQuery.7dd23096.mjs').then(function(n) {
  return n.C;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentRenderer.beea724d.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ContentRendererMarkdown.a0c858c7.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./DocumentDrivenEmpty.847e75ea.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./DocumentDrivenNotFound.015b473c.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./Markdown.8ecb7386.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseA.cbffb5fb.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseBlockquote.54038796.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseCode.b3838a80.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseCodeInline.51c27ecd.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseEm.c9d6bf48.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH1.d8f9f6cd.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH2.ef76b23e.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH3.039cbe40.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH4.e875f52d.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH5.6d1491bc.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseH6.c4f2a7a8.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseHr.1c51fc15.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseImg.d7260f54.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseLi.bdbbb059.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseOl.68e56bdb.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseP.f61cab95.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseStrong.3aa4b159.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTable.01afbf4e.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTbody.87a80d7b.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTd.7731c0f7.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTh.39b60fcd.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseThead.28f79daf.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseTr.bca07944.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./ProseUl.8c276c06.mjs').then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => Promise.resolve().then(function() {
  return welcome$1;
}).then((c) => c.default || c));
vue_cjs_prod.defineAsyncComponent(() => import('./server.mjs').then(function(n) {
...
const _sfc_main = vue_cjs_prod.defineComponent({
  ...
  async setup(props) {
    ...
    if (!queryBuilder.value && useState("dd-navigation", "$pVC8cDxdQ3").value) {
      const { navigation: navigation2 } = useContent();
      return { navigation: navigation2 };
    }
    const { data: navigation } = await useAsyncData(`content-navigation-${hash(queryBuilder.value)}`, () => fetchContentNavigation(queryBuilder.value), "$yi0Bk6nDJP");
    return { navigation };
  },
  render(ctx) {
    const slots = vue_cjs_prod.useSlots();
    const { navigation } = ctx;
    const renderLink = (link) => vue_cjs_prod.h(__nuxt_component_0$1, { to: link._path }, () => link.title);
    const renderLinks = (data, level) => vue_cjs_prod.h("ul", level ? { "data-level": level } : null, data.map((link) => {
      if (link.children) {
        return vue_cjs_prod.h("li", null, [renderLink(link), renderLinks(link.children, level + 1)]);
      }
      return vue_cjs_prod.h("li", null, renderLink(link));
    }));
...
//# sourceMappingURL=ContentNavigation.9c308570.mjs.map
