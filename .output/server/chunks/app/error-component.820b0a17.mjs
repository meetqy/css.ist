...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.be115dab.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.cbcc50b8.mjs'));
...
//# sourceMappingURL=error-component.820b0a17.mjs.map
