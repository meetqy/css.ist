...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.2dbe7f14.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.a2f13a81.mjs'));
...
//# sourceMappingURL=error-component.54c714b5.mjs.map
