...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ea6f315b.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.a91b4d64.mjs'));
...
//# sourceMappingURL=error-component.8b553e75.mjs.map
