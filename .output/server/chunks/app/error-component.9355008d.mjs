...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.da8befc2.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.68c44d03.mjs'));
...
//# sourceMappingURL=error-component.9355008d.mjs.map
