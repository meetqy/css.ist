<template>
  <div class="page">
    ...
    <div class="error">
      ...
      <NuxtLink to="/" class="btn btn-primary rounded-full btn-sm font-thin">
        home
      </NuxtLink>
      <NuxtLink
        to="/about"
        class="btn btn-primary btn-outline btn-sm rounded-full font-thin ml-4"
      >
        about
      </NuxtLink>
    </div>
...
.page {
  @apply h-screen w-full bg-gradient-to-r from-neutral to-neutral-focus overflow-hidden;
}
